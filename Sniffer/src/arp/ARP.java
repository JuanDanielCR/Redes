...
public class ARP {  
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Selecciona interfaz: a la que estas conectado: ");
        deviceIndex = sc.nextInt();
        sc.nextLine();
        System.out.println("Mi Ip:");
        from = sc.nextLine();
        System.out.println("Resuelve la MAC de IP:");
        to = sc.nextLine();

        lanzaPeticion(deviceIndex, from, to);
    }
    
    public static void lanzaPeticion(int indice,String ipAct,String ipResv) {  
  ...
  public static void capturaPaquete()
  {
    ...
    Pcap pcap = Pcap.openLive(device.getName(), snaplen, flags, timeout, errbuf);  
        ...
        if(tipo==2054){ //0x2048 tipo arp
            ...
            System.out.println("MAC resuelta: "+str.toString().substring(0, str.toString().length()-1));
            pcap.breakloop();
        }
    }
    };
